...
test_label_path = "/home/dilee/Desktop/pico-cnn_research/accuracy_test/ImageNet_val_custom_label/val5000_label.txt"

bitlist =  [32,24,16,12,11,10,9,8]

for i in bitlist:

	predict_label_path = "/home/dilee/Desktop/pico-cnn_research/accuracy_test/test_program/vgg19_5000/predict_label_{}bit.txt".format(i)
